...
nt.install_model(net_name_g2.assign, 'script__util__assign__distributed', ['assign'])
nt.install_model(net_name_g2.task, 'script__util__assign__distributed', ['task'])
...
for agent in nt.get_list('node'):
    ...
    for task in nt.get_list('task'):
        ...
        setattr(task_obj, 'current_agent', agent)
