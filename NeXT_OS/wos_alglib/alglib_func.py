...
def get_next_subprob(obj_netalg):
    ...
    while True:   
        ...
        #print('Debug:', layer)
        #print('Debug:', obj_netalg.lst_processed_layer)
        #exit(0)
...
class fmincon_py(net_func.netelmt_group):
    ...
    def __init__(self, info):  
        ...
        #----------------------------------------------------------------
        # self.prob is not needed any more. This variable was 
        # used to link the code tempalte to the corresponding subproblem,
        # but now this can be done via 'parent' attribute
        #
        # The network control problem to be solved
        #self.prob = info['addi_info']['prob']
        #if self.prob == None:
        #    print('alglib_func:fmincon_py: The problem to be solved cannot be None.')
        #    exit(0)
        #----------------------------------------------------------------
    ...
    def gnrt_alg(self):
        ...
        '''
        #################################################################
        # Display the long subproblem expression for debugging
        #print('Subproblem expression is:')
        #print('Debug:', self.parent.get_lexpr())
        #exit(0)
        ...
        print('Protocol layer:', self.parent.layer)
        print('New utility function: \'' + new_new_expr + '\'') 
        print('Variable:', tmp_optvar, '\n')
        ...
        # 4/7/2018, Guan, add for scheme control
        f.write('scheme = ' + str(net_name.scheme) + '\n')
        
        # Guan, 4/9/2018, Coefficient to avoid solver error when solving optimization in Python
        f.write('coef = ' + str(net_name.coef) + '\n')             
        ...
        # print('Debug:')
        # print(self.sym_func)
        # print(self.sym_func.args)
        # print(srepr(self.sym_func))
        # input('...')
        		
        # ### Test		
        # if self.parent.layer == 'phy':
            # import alglib_phypnl
            # print(alglib_phypnl.keyword)
            # print(hasattr(ptcl_name, alglib_phypnl.keyword[0]))
            # input('...')		
        # ### End Test
    ...
    def find_keyword(self, expr):
        ...
        for this_args in preorder_traversal(sym_expr):
            # print('Debug:', this_args)
            # print(type(this_args))
            # input('...')
            # if type(this_args) is str:
                # this_args = sympify(this_args)
            #if this_args.args == () and (alglib_name.key_flag in str(this_args) or alglib_name.key_flag2 in str(this_args) or or alglib_name.key_flag3 in str(this_args)):    	# This is a leaf item and contains keyword flag ('00')
    ...
    def gnrt_pnl(self):
        ...
        # print('Debug:', self.parent.lexpr.lst_leaf)
        # input('...')
        ...
        # Extract the derivative corresponding to the keyword from dict_xtnl_der obtained above
        # print('Debug:', dict_xtnl_der[xtnl_var])
        # input('...')
        ...
        #####################################################################
        # Construct penalization item 
        
        # print('Debug:')
        # print(self.sym_func)
        # x = diff(self.sym_func, sympify(xtnl_para))
        # print(x)
        # x
        # input('...')
        ...
        # Derivative of utility function with respect to external paramter
        # print('XXX:', self.sym_func)
        # print(xtnl_para)
        # input('...')
        utlt_der = diff(self.sym_func, sympify(xtnl_para))
        # print('Debug:', utlt_der)
        # print(simplify(utlt_der))
        # input('...')
		
        # ### Test
		
        # str_der = str(utlt_der)
        # sym_der = sympify(str_der)
        # print('Debug:')
        # print(sym_der)
        # print(utlt_der.evalf(subs = {link_sngl_lbd: 1}))
        # input('...')
		
        # ### End Test		
               
        # # June 15, 2017: Guan
        # # Test symbolic function preorder_traversal()
        # for this_args in preorder_traversal(utlt_der):
            # print('Debug:', this_args)
            # print(type(this_args))
            # input('...')      
    ...
    def dtm_lbd_xchg(self):
        ...
        ##################################################################################
        # Locate the set-type Lagrangian coefficient. For a symbolic expression, look over all
        # argument sub-expressions, and check if there is keyword "lbd" in each sub-expression. 
        # If yes, generate the signaling to be exchanged

        # print('Debug:')
        # print(self.sym_func)
        # print(feat_sngl)
        # print(self.sym_func.args[1])
        # input('...')        
      
        #/*
        # Dec. 14, 2017; Guan; If '+' or '-' are not in the expression, it means there is only one item and no need to loop
        ...
        ##################################################################################
        # Determine the signaling by extracting the coefficient of sum(Lagrangian Coefficient)
        # print('Debug:', str_expr, pos_lbd)
        # input('...')
    ...
    def dtm_varbnd(self, var_inst):
        ...
        # print('Debug:')
        # print(var_name[pos_pre[0]:pos_suf[0]])
        # # print(var_name)
        # # print(pos_pre)
        # # print(pos_suf)
        # exit(0)
    ...
    def analyze_Lag_pattern(self):
        ...
        # print('222:', full_string)
        # print('333:', old_substring)
        # print('444:', new_substring)
        ...
        #//
        # Guan, 12/4/2017, add 
        # Remove dum operation from the expression
        # print('-----')
        # print(new_string)        
        ...
        # Update symbolic expression of utility function 
        # print('111:', new_string)
        # input('...')
    ...
    def find_lbd(self, parent_str):
        ...
        ###################################################################
        # Determine pattern: Does the set correspond to any group-type network element, e.g., lnkses - the set of sessions sharing the same link
        #print('Debug:')
        #print(set_index)
        #print(self.ntwk.every2nonevery)
        #input('...')
