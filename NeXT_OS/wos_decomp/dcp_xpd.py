...
class xpd(net_func.netelmt_group):
    ...
    def __init__(self, info):
        ...
        # changes:
        # no need to count the number of subsets
        #self.subset_cnt = 0                    # total number of subsets, including both element and variable subsets
        
        ### 
        # changes:
        # No need to record utlt and cstr from here; instead, all isntances names are recorded in self.lst_inst with the first being utility and the others
        # being constraints
        
        # self.utlt = None                      # utility object
        # self.cstr = None                      # constraints object
        ###
    ...
    ###
    # Changes:
    # The following three functions need to be rewritten
    #
    # def add_utlt(self, obj_utlt):
        # '''
        # add the utility (its object) to the xpd
        # '''
        # self.utlt = obj_utlt
    ...
    # def get_utlt(self):
        ...
        # '''
        # return self.get_netelmt(self.str_utlt)
        
    # def get_cstr(self, id_cstr):
        # '''
        # return the constraint object with id of id_cstr
        # '''
        # cstr_nm = dcp_name.cstr + str(id_cstr)              # constrcut constraint name
        # return self.get_netelmt(cstr_nm)
    ###
