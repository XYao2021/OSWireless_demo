...
class inst_sym(net_func.netelmt_group):
    ...
    def subs_log(self):
        ...
        # June 7, 2017
        # Commentted to consider more operations. The operation keyword will be detected as below
        #
        # # if no 'log', return directly 
        # if 'log' not in self.expr:
            # return None
        ...
        # #print(lst_vec)
        #
        # June 6, 2017, use '[' and ']' to locate the instance vector
        ...
        # #print(new_str)
        #
        # June 6, 2017: Replace the instance vector in [] using individual element
        # construct the new string
        new_str = ''
        for x in lst_vec:
